    ...
    <div className="page internship-page">
      ...
      <div className="page-content">
        ...
        <div className="right">
          ...
          <p>Today, our ecosystems are overflowing with plastics. It is immensely painful to
            see, what we have made of Mother Nature! From sky to oceans and the ground,
            anthropogenic activities are damaging our Planet. Let's come together and adopt practices that promote sustainability, reuse,
            recycling and waste minimisation. Every step counts!</p>
