    ...
    <div className="page internship-page">
      ...
      <div className="page-content">
        ...
        <div className="right">
          ...
          <p>Join the adventure with DNA Life to understand different tools and techniques of
              farming, indwelling of local heritage with nature, ancient medicinal system (Nati-
              Vaidya), visiting rain hill and much more. Practical learning plus the fun!</p>
