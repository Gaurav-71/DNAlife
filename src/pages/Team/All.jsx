...
export const Members = [
  {name: "Prof. Malali Gowda", src: malali, position: "Founding President & Trustee"},
  {name: "Mahantesh Veerapur", src: mahantesh , position: "Secretary & Trustee"},
  ...
  {name: "Srihari Prathapaneni", src: sri , position : "Team Leader, Karnataka"},
];
