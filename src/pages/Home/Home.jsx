    ...
    <div className="page home-page"    >
      ...
      <section className="common parallax-container black">
        ...
        <section className="content">
          ...
          <div className="body"><p>DNA Life Organisation was established in 2016 under Indian Trust Act with the objective of establishing greener environment by engaging local communities to restore forest ecosystems and promote sustainable land management and livelihood approaches. DNA Life Organisation offers training on agriculture practices, social forestry, mixed farming and rural livelihood.</p>
          <Link to="/about-us" className="about-button">Read more</Link></div>
        </section>
      </section>
      <section className="activities parallax-container">
        ...
        <section className="content">
          <Link to="/activities/educational-tours" className="rect one parallax-container">
          <div className="parallax-wrap">
              <div className="parallax-inner"></div>
            </div>
          ...
          <Link to="/activities/educational-tours" className="rect two parallax-container">
          <div className="parallax-wrap">
              <div className="parallax-inner"></div>
            </div>
            <section className="rect-content">
          ...
          <Link to="/activities/educational-tours" className="rect three parallax-container">
          <div className="parallax-wrap">
              <div className="parallax-inner"></div>
            </div>
            <section className="rect-content">
          ...
          <Link to="/activities/educational-tours" className="rect four parallax-container">
            <div className="parallax-wrap">
              <div className="parallax-inner"></div>
            </div>
            <section className="rect-content">
      ...
      <section className="nelson parallax-container">
        ...
        <section className="content">
          ...
          <p>
            The Nelson Institute is home to three interdisciplinary research centers that serve
            as laboratories and incubators to solve today's most challenging environmental
            issues through interdisciplinary research through hands-on educational initiatives that bridge classrooms and communities; and through public programs that foster
            environmental conversation among people. The MS program spans 15 months:
      ...
      <section className="team parallax-container black">
        ...
        <section className="content">
          ...
          <div className="body">
            ...
            <section className="more"><Link className="link" to="/team">Click here,</Link><p>to view the list of directors, members and activists who make us a valuable team of professionals</p></section> 
          </div>
        </section>
      </section>
      ...
      <section className="common parallax-container black">
        ...
        <section className="content">
          ...
          <div className="body">
       <p>Join The Green Team ! We are always on the lookout for passionate, determined and like-minded people to join us and make a difference to the society with green initiatives to mitigate climate change and much more.</p>
       <Link to="/about-us" className="about-button">Become a member now</Link>
          </div>
        </section>
      </section>
