...
export default function AdminEduTour({ activityType }) {
  ...
  const activityReducerData = useSelector((state) =>
    activityType === "Internships"
      ? state.internshipReducer
      : activityType === "Trainings"
      ? state.trainingReducer
      : activityType === "CertificateCourses"
      ? state.certificateCourseReducer
      : null
  );
  const isSuccess = useSelector((state) =>
    activityType === "Internships"
      ? state.internshipReducer.successful
      : activityType === "Trainings"
      ? state.trainingReducer.successful
      : activityType === "CertificateCourses"
      ? state.certificateCourseReducer.successful
      : null
  );
  useEffect(() => {
  ...
  let activities = activityReducerData.education;
